...
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Inventory Manager | Senior Portfolio</title>
...
<nav class="flex items-center justify-between px-8 py-6 bg-white shadow-sm">
    <div class="text-xl font-bold tracking-tight text-blue-600">
        Inventory<span class="text-gray-800">Manager</span>
    </div>
    <div>
        @if (Route::has('login'))
            ...
            <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                <div class="sm:text-center lg:text-left">
                    ...
                    <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-auto">
                        A robust, scalable application built with <strong>Laravel 11</strong> and
                        <strong>FilamentPHP</strong>. Featuring Role-Based Access Control, Real-time Validation, and
                    ...
                    <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                        ...
                        <div class="mt-3 sm:mt-0 sm:ml-3">
                            <a href="https://github.com/yourusername/inventory" target="_blank"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="lg:text-center">
            ...
            <p class="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
                This isn't just a CRUD app. It's an architectural demonstration.
            </p>
        </div>
            ...
            <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-8 md:gap-y-10">
                ...
                <div class="relative">
                    <dt>
                        ...
                        <p class="ml-16 text-lg leading-6 font-medium text-gray-900">RBAC Security</p>
                    </dt>
                    <dd class="mt-2 ml-16 text-base text-gray-500">
                        Robust Role-Based Access Control using PHP Enums and Laravel Policies. Admins govern users;
                        Managers govern inventory.
                    </dd>
                </div>
                ...
                <div class="relative">
                    <dt>
                        ...
                        <p class="ml-16 text-lg leading-6 font-medium text-gray-900">Live Wire</p>
                    </dt>
                    <dd class="mt-2 ml-16 text-base text-gray-500">
                        Reactive frontend experience powered by Livewire. Slugs auto-generate and forms validate in
                ...
                <div class="relative">
                    <dt>
                        ...
                        <p class="ml-16 text-lg leading-6 font-medium text-gray-900">Strict Typing</p>
                    </dt>
                    <dd class="mt-2 ml-16 text-base text-gray-500">
                        Database integrity enforced with Foreign Key constraints and PHP 8.2+ Typed Properties and
                        Enums.
                    </dd>
                </div>
            </dl>
...
<footer class="bg-white border-t border-gray-200 mt-12">
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <p class="text-center text-base text-gray-400">
            &copy; {{ date('Y') }} Inventory Manager Portfolio Project. Built with Laravel & Filament.
        </p>
    </div>
</footer>
</body>
